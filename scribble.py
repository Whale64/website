    ...
    def open_about_page(self):
        ...
        <body style="background-color: #4a4a4a; color: white; font-family: sans-serif; padding: 20px;">
            ...
            <p style="font-size: 16px; line-height: 1.6;">
                Scribble is a simple yet stylish notepad application built with PyQt6.
                It features a modern, dark user interface inspired by the provided design
                and offers essential text editing capabilities, including multiple tabs
